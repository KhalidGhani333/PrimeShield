...
export function Shield({ className = "h-6 w-6", style }: { className?: string; style?: CSSProperties }) {
  return (
...
export function ArrowRight({ className = "h-4 w-4", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden="true">
...
export function Check({ className = "h-4 w-4", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden="true">
...
export function ChevronDown({ className = "h-4 w-4", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden="true">
...
export function Star({ className = "h-4 w-4", style }: { className?: string; style?: CSSProperties }) {
  return (
...
export function Phone({ className = "h-4 w-4", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden="true">
...
export function Chat({ className = "h-5 w-5", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden="true">
...
export function Close({ className = "h-5 w-5", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden="true">
...
export function Menu({ className = "h-6 w-6", style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} style={style} aria-hidden="true">
